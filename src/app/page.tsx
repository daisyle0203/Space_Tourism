...
import { SCALE_UP, SLIDE_LEFT } from "@/utils"
  ...
  return (
    <MotionDiv>
      ...
      <main className="relative z-10 min-h-[80vh] flex flex-col justify-evenly items-center lg:flex-row lg:items-end lg:justify-between lg:p-32">
        <motion.div
          variants={SLIDE_LEFT}
          className="text-secondary text-center px-4 md:max-w-lg md:mx-auto lg:mx-0 lg:text-left"
        >
        ...
        <motion.div
          ...
          variants={SCALE_UP}
          className="bg-white w-48 h-48 rounded-full flex items-center justify-center text-bellefair tracking-[1.25px] uppercase relative group md:w-60 md:h-60 lg:w-72 lg:h-72"
        >
